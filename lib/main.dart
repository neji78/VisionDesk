...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //     "x": 0.1,     // 10% from left
  //     "y": 0.2,     // 20% from top
  //     "width": 0.3, // 30% width of image
  //     "height": 0.4 // 40% height of image
  //   },
  //   {
  //     "x": 0.6,
  //     "y": 0.3,
        ...
        await _displayPickImageDialog(context, false, (double? maxWidth,
          ...
          try {
            ...
            for(var object in detectedObjects!){
              ...
              var x1 = object.bbox[0];
              var y1 = object.bbox[1];
              var height = (object.bbox[2] - object.bbox[0]);
              var width  = (object.bbox[3] - object.bbox[1]);
              _boxes.add({
                "x1":x1,
                "y1":y1,
                "width":width,
            ...
            logger.d("boxes ${_boxes.first.values}");
            setState(() {
